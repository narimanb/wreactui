export default {
	...
	// TableContainer
	tableContainer: {
		base: 'w-full overflow-hidden rounded-lg ring-1 ring-black/5',
	},
	// TableCell
	tableCell: {
		base: 'px-4 py-3',
	...
	// Backdrop
	backdrop: {
		base: 'fixed inset-0 z-40 flex items-end bg-black/50 sm:items-center sm:justify-center',
	},
	// Textarea
	textarea: {
		...
		disabled: 'cursor-not-allowed bg-gray-300/50 dark:bg-gray-800',
		valid:
	...
	// Card
	card: {
		base: 'min-w-0 rounded-lg ring-1 ring-black/5 overflow-hidden',
	...
	button: {
		...
		outline: {
			...
			disabled: 'cursor-not-allowed bg-gray-300/50',
		},
		link: {
			base: 'text-gray-600 dark:text-gray-400 focus:outline-none border border-transparent',
			active:
				'active:bg-transparent hover:bg-gray-100 focus:ring focus:ring-gray-300 dark:hover:bg-gray-500 dark:hover:text-gray-300 dark:hover:bg-gray/10',
			disabled: 'opacity-50 cursor-not-allowed',
		},
